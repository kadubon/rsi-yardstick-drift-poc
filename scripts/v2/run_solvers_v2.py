...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run v2 solver conditions with local Ollama and save raw JSONL outputs.")
...
def main() -> None:
    ...
    prompt_path = pathlib.Path(preset["prompt_path"])
    ...
    records: list[dict[str, object]] = [
        {
            ...
            "notes": "v2 run with keep_alive=0s. Calibration and held-out separation happen downstream at evaluation time.",
        }
    ]
